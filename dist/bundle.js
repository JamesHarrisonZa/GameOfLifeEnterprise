...
const myGrid = new grid_1.Grid(new startingCells_1.StartingCells(windowHeight, windowWidth), new gameOfLife_1.GameOfLife(), window.document);
...
Object.defineProperty(exports, "__esModule", { value: true });
class Grid {
    constructor(startingCells, gameOfLife, document) {
...
class StartingCells {
    constructor(windowHeight, windowWidth) {
        ...
        this.getCellsWidth = (windowWidth) => {
